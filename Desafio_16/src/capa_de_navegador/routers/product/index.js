...
import { ProductDao } from "../../../capa_de_servicio/dao/index.js";
import { DATE_UTILS, ERRORS_UTILS, JOI_VALIDATOR } from "../../../utils/index.js";
import { verifyRole } from "../../../capa_de_navegador/middlewares/index.js";
...
router.delete("/:id", verifyRole, async (req, res) => {
  try {
    const { id } = req.params;
    const element = await ProductDao.deleteById(id);
