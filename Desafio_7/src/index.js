...
import { URL } from "url";
import ContainerSQ3 from "./containers/Sqlite3.js";
import ContainerMDB from "./containers/MariaDB.js";
...
const productContainer = new ContainerMDB("products");
const messagesContainer = new ContainerSQ3("messages");
