...
class FilesystemContainer {
  ...
  async getAll() {
    try {
      ...
      logger.error("error at getAll in FileSystem", error);
    }
  }
  async save(element) {
    try {
      ...
      logger.error("error at save in FileSystem", error);
    }
  }
  ...
  async getById(id) {
    try {
      ...
      logger.error("error at getById in FileSystem", error);
    }
  }
  ...
  async deleteById(id) {
    try {
      ...
      logger.error("error at deleteById in FileSystem", error);
    }
  }
  async deleteAll() {
    try {
      ...
      logger.error("error at deleteAll in FileSystem", error);
    }
  }
  async updateById(id, newData) {
    try {
      ...
      logger.error("error at updateById in FileSystem", error);
    }
  }
}
